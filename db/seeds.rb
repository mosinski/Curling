...
User.create(:username => ENV['user2_login'], :password => ENV['user2_password'], :password_confirmation => ENV['user2_password'], :email => "hansskowron@interia.pl", :name_surname => "Henryk Skowroński", :born => "1990-02-24", :pesel => "11062113570", :role => "admin", :potwierdzenie => 1)
